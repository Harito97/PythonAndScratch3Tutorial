...
# str = 2 + (4+3) * 3 - 3 = 2 + 7 * 3 - 3 = 2 + 21 - 3 = 23 - 3 = 20
...
bt_add = tk.Button(text='+', bg='green', font='Times 15 bold', fg='white', width=10, height=3, command=lambda: add())
bt_sub = tk.Button(text='-', bg='green', font='Times 15 bold', fg='white', width=10, height=3)
bt_equal = tk.Button(text='=', bg='green', font='Times 15 bold', fg='white', width=10, height=3, command=lambda: equal())
